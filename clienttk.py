...
messages_frame = tk.Frame(top, width= 150, height=190, bd=3, bg="RosyBrown")
...
send_button = tk.Button(field_frame, text="Send", command=send, bg="LavenderBlush", fg="Black", width=26, height=2, font=helv36)
clear_button = tk.Button(field_frame, text="Clear", command=clear, bg="LightPink", fg="Black", width=26, height=2, font=helv36)
